...
infile = '/Users/jason/Dropbox/JournalMap/scripts/DataImport/Biostor_import/biostor-geotagged.txt'
...
with open(outpath+'articles.csv','wb') as articlesCSV:
    with open(outpath+'locations.csv','wb') as locationsCSV:
